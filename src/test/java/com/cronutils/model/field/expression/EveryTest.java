...
public class EveryTest {
    ...
    public void testGetTime() throws Exception {
        int every = 5;
        assertEquals(every, (int)new Every(nullFieldConstraints, new IntegerFieldValue(every)).getRepeat().getValue());
    }

    @Test
    public void testGetTimeNull() throws Exception {
        assertEquals(1, (int)new Every(nullFieldConstraints, null).getRepeat().getValue());
    }
}